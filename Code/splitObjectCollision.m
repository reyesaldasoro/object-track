function [numObjectsToSplit,dataL,handles] = splitObjectCollision(handles,dataRe)
%function [numObjectsToSplit,dataL,handles] = splitObjectCollision(handles,dataRe)
%
%--------------------------------------------------------------------------
% splitObjectCollision  a routine to split all those cells that have been detected as a 
...
collisionNetwork                                = detectObjectCollision(handles);
