function [dataR,handles] = reduceObject(dataIn,numLevels,handles)
%function [dataR,handles] = reduceObject(dataIn,numLevels,handles)
%
%--------------------------------------------------------------------------
% reduceObject  reduces spatial resolution of data
%   
%       INPUT
...
%
%     The objectTrack package is free software: you can redistribute it and/
%     or modify it under the terms of the GNU General Public License as 
%     published by the Free Software Foundation, version 3 of the License.
%
%     The objectTrack package is distributed in the hope that it will be 
...
%--------------------------------------------------------------------------
%
% This m-file is part of the objectTrack package used to analyse small
% objects as observed through confocal or multiphoton microscopes.  For 
...
if isa(dataIn,'char')
    ...
    for counterDir=1:numFrames
      ...
      dataR = reduceObject(dataIn2,numLevels);
