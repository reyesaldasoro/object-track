function firstNetwork=positionObject(dataIn,currFrameExternal,calculateSphericity)
%function firstNetwork=positionObject(dataIn,currFrameExternal,calculateSphericity)
%
%--------------------------------------------------------------------------
% positionObject  calculates the first metrics that will form handles.nodeNetwork:
%     first elements of the tracking process, get X, Y, Z for each object, then:
%       4      - distance to closest neighbour
%       5      - frame
%       10     - area of object
%       11     - label at frame 
%       15:20  - bounding box of object
...
if isa(dataIn,'char')
    ...
    for counterDir=1:numFrames
        ...
        currentCentroids3                   = positionObject(dataIn2,counterDir,calculateSphericity);
    ...
    for countFrames=1:numFrames
        ...
        if ~isempty(currentProps)
            ...
            %     %Obtain Sphericity of each object
