function [numObjectsChanged,dataL,handles] = linkLostObject(handles,dataRe)
%function [numObjectsChanged,dataL,handles] = linkLostObject(handles,dataRe)
%
%--------------------------------------------------------------------------
% linkLostObject links cells that may be lost due to changes of intensity  
...
%
%       OUTPUT
%         numObjectsChanged:	number of linked objects
