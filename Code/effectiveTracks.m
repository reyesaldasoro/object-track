...
%% New metrics based on the activation of the objects
...
%detect which objects are active
...
% set the values of non active objects to nan
...
%% get the ratio of the number of hops that are inactive vs those after activation of the object
% this is more reliable than the number of object active relative to total as small tracks would bias
