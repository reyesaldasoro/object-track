function [dataL,handles,statsData]=thresObject(dataIn,handles)
%function [dataL,handles,statsData]=thresObject(dataIn,handles)
%
%--------------------------------------------------------------------------
% thresObject threshold data to generate labelled images containing only
%     objects
%
%       INPUT
...
%
%     The objectTrack package is free software: you can redistribute it 
