...
% ---- The main orientation of the MOVEMENT of the objects is obtained from the ANGLE of all tracks --- 
...
for counterTrack = 1:numTracks
    ...
    %find if the object gets to the wound or not
    ...
    % detect if the object starts movement towards the wound and when it starts
    ...
    if isempty(isCurrNeutActive)
        ...
        %to be an active object, the track has to be AT LEAST, 15 hops in length after the initiation
