...
%     If the woundRegion is provided, it then calculates whether a object 
...
%     (those movements before the object reaches the wound), 
%     handles.explorationNetwork (those movements after the object 
%     reaches the wound) and handles.inWoundNetwork (a register if the 
%     object is inside or outside the wound). 
...
if exist('woundRegion','var')
    ...
    %%
    %calculate the ratio of time the object is idle once it is in the wound
    tempDenom                               = handles.distanceNetwork.numHopsExploration;
    ...
    %calculate the ratio of time the object is leaving the wound 
