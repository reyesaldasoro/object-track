function [finalLabel] = objectOverlap(firstNetwork,linkedNetwork,handles)
%function [finalLabel] = objectOverlap(firstNetwork,linkedNetwork,handles)
% 
%
%--------------------------------------------------------------------------
% objectOverlap  analyses if objects overlap between time frames
%
%       INPUT
        ...
        if tt(5,k)~=0
            ...
            if tt(6,k)==0
                ...
                if (tt(1,k)~=0)&(tt(2,k)~=0)               
                    ...
                    %once parenthood is assigned, the volumes should also be updated as objects may be
